"""
XAU/USD SNIPER v4.3 - MODE SIMULATION METAAPI [ENGINE v4]
...
OPTIMISATIONS v4 :
  1. RETEST_THRESH 3.64->4.55 : +3 trades, WR stable, DD reduit
  2. RSI directionnel : BUY exige RSI>50, SELL exige RSI<50
  Sessions : Pre-Londres + Matin + Pre-NY + Apres-midi (inchangees)

HISTORIQUE :
  v2 : score 50, retest 3.64            -> WR 48%, DD -$80
  v3 : score 75, RSI 45-55, SL 4500    -> WR 55.3%, DD -$38
  v4 : retest 4.55, RSI directionnel   -> WR cible 60%+
"""
...
async def main():
    print("="*60, flush=True)
    print("XAU/USD SNIPER v4.3 - SIMULATION METAAPI M1 [v4]", flush=True)
    ...
    print("Retest  : " + str(RETEST_THRESH) + " pts | SL_MAX : "
          + str(SL_MAX_PIPS) + " pips", flush=True)
